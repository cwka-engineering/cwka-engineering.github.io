...
> **Related**: [Takeoffs](/workflows/fabrication-engineer/takeoffs.html) | [FE to PE Release SOP](/workflows/fe-to-pe-release.html)
...
- Follow [Rhino Drafting and Layouts](/standards/rhino-drafting/) standards.
...
- See [FE to PE Release SOP](/workflows/fe-to-pe-release.html) for complete release procedure
