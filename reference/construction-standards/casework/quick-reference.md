---
layout: default
title: Critical Dimensions Quick Reference
...
Fast lookup for the reveals, pull/hinge positions, thresholds, and material thicknesses used across the [Casework](/reference/construction-standards/casework/) construction standard. For full context and exceptions, see the per-cabinet-family pages linked from each table.

## Reveals and Clearances
...
| Upper cabinet door to top/bottom | FLUSH (0" reveal) — see [Upper Cabinets](/reference/construction-standards/casework/upper-cabinets.html) |
| Tall cabinet door to top/bottom | FLUSH (0" reveal) — see [Tall Cabinets](/reference/construction-standards/casework/tall-cabinets.html) |
...
## Pull Positions by Cabinet Type
...
## Hinge Positions by Cabinet Type
...
> **Note:** There is exactly one nailer material/thickness — 0.75" shop plywood — used identically across base, tall, and upper cabinets. Don't treat upper-cabinet nailers as a distinct "panel stock" spec.
