---
layout: default
title: Toggl Setup & Upload
permalink: /tools/time-entry/toggl.html
parent: Time Entry
grand_parent: Tools
nav_order: 1
---
...
> **Related**: [Time Entry](/tools/time-entry.html)
...
## How do I create time entries in Toggl?
{: #how-to-create-toggl-entry}
...
The spreadsheet maps Toggl's structure (Client/Project/Tag) to Epicor's structure (Job/Operation).
