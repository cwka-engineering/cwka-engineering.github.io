...
- Outsource Program Manager note enriched with intended purpose (standing up offshore/outsource millwork partners for lower-complexity submittal drawing labor) — explicitly marked as a **planned, not yet formally rolled-out** role, not a currently-filled position. Same correction applied to `_data/departments.yml`.
